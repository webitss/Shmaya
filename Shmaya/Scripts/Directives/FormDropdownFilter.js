companionApp.directive('formDropdownFilter', function ($timeout, $window, $filter, $rootScope,connect) {
        return {
            restrict: 'E',
            require: '^ngModel',
            templateUrl: 'Partials/Templates/FormDropdownFilterTemplate.html' + $rootScope.appVersionParameter,
            replace: true,
            scope: {
                ngModel: '=',
				title: '@',
            ...
            link: function (scope, elem, attr, ngModel) {
				...
				connect.post(true, scope.getfunc,
					scope.datafunc,
					function (result) {
						scope.data = result;
					});
